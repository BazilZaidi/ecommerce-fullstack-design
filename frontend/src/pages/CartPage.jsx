...
function CartPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-gray-800 mb-8">Your Cart ({cartItems.length} items)</h1>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div key={item._id} className="bg-white rounded-xl shadow p-4 flex gap-4 items-center">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 mt-2">
                  <button onClick={() => updateQuantity(item._id, item.quantity - 1)} className="w-7 h-7 rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-100">−</button>
              ...
              <div className="text-right">
                ...
                <button onClick={() => removeItem(item._id)} className="text-red-400 hover:text-red-600 text-sm mt-2">Remove</button>
              </div>
            </div>
          ))}
        ...
        <div className="lg:w-80">
          <div className="bg-white rounded-xl shadow p-6 sticky top-20">
            ...
            <div className="mt-4 text-center text-xs text-gray-400">🔒 Secure & encrypted checkout</div>
          </div>
        </div>
      </div>
    </div>
