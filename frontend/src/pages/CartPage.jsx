...
// Pretend user has these items in cart (static for now)
const cartItems = [
            ...
            <div key={item.id} className="bg-white rounded-xl shadow p-4 flex gap-4 items-center">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 mt-2">
                  <button className="w-7 h-7 rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-100">−</button>
              ...
              <div className="text-right">
                ...
                <button className="text-red-400 hover:text-red-600 text-sm mt-2">Remove</button>
              </div>
